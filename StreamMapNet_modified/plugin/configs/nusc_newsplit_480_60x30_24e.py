...
# data_ann = '/home/guxunjia/data/stream_new_split/'
# data_ann = '/home/guxunjia/data/stream_mini/'
data_ann = '/home/guxunjia/data/stream_full/'
...
eval_config = dict(
    ...
    ann_file=data_ann + 'nuscenes_map_infos_val.pkl', # './datasets/nuScenes/nuscenes_map_infos_val_newsplit.pkl',
    meta=meta,
    roi_size=roi_size,
    cat2id=cat2id,
    pipeline=[
...
data = dict(
    ...
    train=dict(
        type='NuscDataset',
        data_root='/home/data/nuscenes',
        ann_file='/home/guxunjia/data/stream_new_split/nuscenes_map_infos_train_newsplit.pkl',
        # ann_file='/home/guxunjia/data/stream_mini/nuscenes_map_infos_train.pkl',
        meta=meta,
        roi_size=roi_size,
        cat2id=cat2id,
    ...
    val=dict(
        type='NuscDataset',
        data_root='/home/data/nuscenes',
        # ann_file='/home/guxunjia/data/stream_new_split/nuscenes_map_infos_val_newsplit.pkl',
...
optimizer = dict(
    ...
    weight_decay=1e-2)
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2)) ##################################################################3
