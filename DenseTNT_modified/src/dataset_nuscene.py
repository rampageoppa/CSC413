...
def nuscene_get_instance(args: utils.Args, instance_dir, uncertainty=False, centerline=False, boundaries=True):
    ...
    # version_3 (final)
    # bev_features = np.transpose(vec_map['bev_features'], (1, 2, 0))      # 100, 50, 256
    # bev_embed = torch.tensor(np.flip(bev_features, axis=0).copy())                     # 100, 50, 256

    # MapTR
    bev_embed = torch.tensor(vec_map['bev_features'].reshape(200, 100, 256))
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Load and preprocess data on-the-fly
        # Replace `load_and_preprocess_data` with the actual function to load and preprocess your data
    ...
    def load_and_preprocess_data(self, args, file_path):
        ...
        # This is a placeholder function. Implement your actual data loading and preprocessing logic here.
        # For example, you could load a pickle file and decompress it as shown below:
