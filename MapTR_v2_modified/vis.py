...
with open('/home/guxunjia/project/distance_data_maptr.pkl', 'rb') as handle:
    data1 = pickle.load(handle)

with open('/home/guxunjia/project/distance_data_stream.pkl', 'rb') as handle:
    data2 = pickle.load(handle)

with open('/home/guxunjia/project/distance_data_maptrv2.pkl', 'rb') as handle:
    data3 = pickle.load(handle)

with open('/home/guxunjia/project/distance_data_maptrv2_cent.pkl', 'rb') as handle:
...
def plot_points_with_laplace_variances(x, y, beta_x, beta_y, labels, scores, sample_idx):
    ...
    plt.show()
    # plt.savefig('/home/guxunjia/project/final_plots/maptrv2_cent/' + sample_idx + '.png', bbox_inches='tight', format='png',dpi=1200)
    plt.close(fig)


# with open('/home/guxunjia/project/MapTR_v2_modified/results_centerline_24_full_val.pickle', 'rb') as handle:
with open('/home/guxunjia/project/pkl_files_adaptor_maptr/results_full_val.pickle', 'rb') as handle:
    data = pickle.load(handle)

with open('/home/guxunjia/project/pkl_files_adaptor_maptr/vec_scene_full_val.pkl', 'rb') as handle:
...
# plt.show()
# plt.savefig('/home/guxunjia/project/final_plots/distance/' + 'MapTR' + '.png', bbox_inches='tight', format='png',dpi=1200)
# plt.savefig('/home/guxunjia/project/final_plots/distance/' + 'MapTR' + '.pdf', bbox_inches='tight', format='pdf',dpi=1200)
...
save_path = '/home/guxunjia/project/distance_data_maptr.pkl'
with open(save_path, 'wb') as file:
    pickle.dump(data, file)
